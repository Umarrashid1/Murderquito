...
class CameraCalibrator:  #TODO unfinished
    ...
    def reverse_project(self):
        ...
        point = cv2.projectPoints(pixel, np.zeros((3, 1)), np.zeros((3, 1)), self.camera_matrix, self.dist, flags=cv2.SOLVEPNP_UPNP)[0][0][0]        # Convert the 3D point to spherical coordinates
